      ...
      >
        <ArkSlider.Track
          className={cn(
            ...
            "data-[orientation=horizontal]:h-3.5 data-[orientation=horizontal]:w-full",
            "pointer-coarse:data-[orientation=horizontal]:h-5",
          ...
          return (
            <ArkSlider.Thumb
              className={cn(
                ...
                "pointer-coarse:size-9 pointer-coarse:after:absolute pointer-coarse:after:h-full pointer-coarse:after:min-h-11",
