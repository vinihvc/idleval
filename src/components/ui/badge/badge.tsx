  ...
  variants: {
    variant: {
      ...
      purple: [
        "bg-purple",
        "text-white",
        "border-purple-foreground",
        "focus-visible:ring-purple/50",
        "[a&]:hover:brightness-105 [button&]:hover:brightness-105",
      ],
      teal: [
        "bg-teal",
        "text-white",
        "border-teal-foreground",
      ...
      olive: [
        "bg-olive",
        "text-white",
        "border-olive-foreground",
        "focus-visible:ring-olive/50",
        "[a&]:hover:brightness-105 [button&]:hover:brightness-105",
      ],
      wine: [
        "bg-wine",
        "text-white",
        "border-wine-foreground",
      ...
      ember: [
        ...
        "border-ember-foreground",
        "focus-visible:ring-ember/50",
        "[a&]:hover:brightness-105 [button&]:hover:brightness-105",
      ],
      destructive: [
        "bg-destructive",
